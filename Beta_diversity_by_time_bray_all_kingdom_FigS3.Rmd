...
#others and merge
skin_merged <- rbind(bacterial_skin, viral_skin, fungal_skin, colSums(others_skin[2:nrow(others_skin),]))
...
pdf(file="Ac_PCoA_bray_kinetics_withHV_allkingdom.pdf", height=6, width=5, useDingbats=F)
ggplot(pcoa_Ac_df3) +
  geom_rect(data=rect_table, aes(xmin=0, xmax=as.numeric(period), ymin=-Inf, ymax=Inf), fill="black", alpha=0.05) +
  geom_point(aes(x=DPI, y=jac_value, group=Subject, color=Treatment2), alpha=1, size=1) + 
  geom_line(aes(x=DPI, y=jac_value, group=Subject, color=Treatment2), alpha=0.75) + 
...
pdf(file="Ra_PCoA_bray_kinetics_withHV_allkingdom.pdf", height=6, width=5, useDingbats=F)
ggplot(pcoa_Ra_df3) +
  geom_rect(data=rect_table, aes(xmin=0, xmax=as.numeric(period), ymin=-Inf, ymax=Inf), fill="black", alpha=0.05) +
  geom_point(aes(x=DPI, y=jac_value, group=Subject, color=Treatment2), alpha=1, size=1) + 
  geom_line(aes(x=DPI, y=jac_value, group=Subject, color=Treatment2), alpha=0.75) + 
...
pdf(file="Vf_PCoA_bray_kinetics_withHV_allkingdom.pdf", height=6, width=5, useDingbats=F)
ggplot(pcoa_Vf_df3) +
  geom_rect(data=rect_table, aes(xmin=0, xmax=as.numeric(period), ymin=-Inf, ymax=Inf), fill="black", alpha=0.05) +
  geom_point(aes(x=DPI, y=jac_value, group=Subject, color=Treatment2), alpha=1, size=1) + 
  geom_line(aes(x=DPI, y=jac_value, group=Subject, color=Treatment2), alpha=0.75) + 
